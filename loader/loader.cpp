...
void onExit() {
    ...
    std::string command_pre = "killall main";
...
int listen()
{
    ...
    while (true)
    {
        ...
        if (lastChanges[parentPath] != lastWriteTime)
        {
            ...
            std::string directory = "/Users/nadavavnon/Desktop/Coding/graphs";
            std::string program = "./main"; // Replace this with the name of the program you want to execute
